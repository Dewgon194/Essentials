...
public class JumpCmd extends BaseCommand {
    ...
    public void jump(Player player) {
        Cooldown cooldown = Cooldown.getCooldown(player, "jump");
        if (cooldown == null || cooldown.isExpired()) {
            ...
            long duration = Cooldown.getDurationFromPermission(player, "essentials.command.jump.");
            Cooldown newCooldown = new Cooldown(player, "jump", (int) duration);
            newCooldown.save();
